...
int main() {
    ...
    std::cout << "This is a test of q1-q7" << std::endl;
...
//    Vector<int> q3v{1,5,3,4,5,5,5,5,6,7,5,5};
    Vector<int> q3v{1,2,3,3};
    std::cout << "Majority Element for the test case1 is: "
              << std::to_string(findMajorityElement(q3v)) << std::endl;
    Vector<int> q3v1{1,2,3,3,3};
    std::cout << "Majority Element for the test case2 is: "
              << std::to_string(findMajorityElement(q3v1)) << std::endl;
